...
namespace Code._Ships.ShipComponents.ExternalComponents.Weapons.Types {
    public class Laser : Weapon {
        ...
        public Laser(ShipComponentTier componentSize) : base("Laser", componentSize, minTierFireDelay, maxTierFireDelay, baseDamage, projectileSpeed, travelTime, basePowerDraw, minTierRotationSpeed, maxTierRotationSpeed, baseMass) {
