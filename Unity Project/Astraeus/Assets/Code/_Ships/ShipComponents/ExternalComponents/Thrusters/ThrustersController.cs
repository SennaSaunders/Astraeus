...
namespace Code._Ships.ShipComponents.ExternalComponents.Thrusters {
    public class ThrustersController {
        ...
        public ThrustersController(List<MainThruster> mainThrusters, List<ManoeuvringThruster> manoeuvringThrusters, float shipMass) {
            _shipMass = shipMass;
