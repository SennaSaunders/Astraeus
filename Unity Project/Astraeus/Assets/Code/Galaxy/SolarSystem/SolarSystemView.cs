...
namespace Code.Galaxy {
    public class SolarSystemView : MonoBehaviour {
        ...
        public static readonly int ZOffset = 2500;
        public void SetupSolarSystemView() {
            string systemName = "SolarSystem";
        ...
        public void DisplaySolarSystem(SolarSystem solarSystem) {
            ...
            for (int i = 0; i < solarSystem.Bodies.Count; i++) {
                ...
                if (hasParent) {
                    ...
                    rotationHolder.transform.localEulerAngles = new Vector3(0, 0, currentBody._rotationCurrent * 360);
