    ...
    public class GameControllerEditor : Editor {
        ...
        public override void OnInspectorGUI() {
            ...
            if (GUILayout.Button("Clear NPCs")) {
                ...
                gameController.npcShips = new List<Ship>();
            }
            ...
            foreach (Ship gameControllerNpcShip in gameController.npcShips) {
                shipNameList.Add(shipCount + " - " + gameControllerNpcShip.name);
                shipCount++;
            }
            // var shipNames = gameController.npcShips.Select(s => s.ShipObject.name).ToArray();
